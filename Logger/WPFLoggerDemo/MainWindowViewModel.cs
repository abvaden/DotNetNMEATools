...
namespace WPFLoggerDemo
{
    public class MainWindowViewModel : ViewModels.ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            AvailableViewModels = new ObservableCollection<ViewModels.NMEASentences.DataViewModelBase>();
            AvailableViewModels.Add(new ViewModels.NMEASentences.MapViewModel(_Listerner));
