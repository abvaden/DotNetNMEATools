...
{
    public class Listener : IObservable<IListenerSubscriber>
    {
        ...
        private ICollection<IObserver<IListenerSubscriber>> _Subscribers;
        ...
        public Listener()
        {
            ...
            _Subscribers = new List<IObserver<IListenerSubscriber>>();
